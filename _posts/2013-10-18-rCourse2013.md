...
This tutorial is meant for individuals interested in learning the basics of R for simple statistics and data visualization.  I have been teaching R to undergraduate students and high schoolers interested in a career in biological science, but almost of all of the material requires no knowledge of biology.  The overall goal is to get scientists to move from Excel to R, so whenever possible I make comparison to how R and Excel are the same and different.  This tutorial is written under the assumption that the reader has little to no programming experience, therefore many beginning coding concepts are also introduced.  Much of the material can be applied to R run through any interface, but this tutorial is written for use with the standard R installation.
...
<a href="/downloads/workingDirectory.zip" target="_blank">Files to download</a>
...
<img src="/img/screenShot2.png" class="img-responsive" alt="Responsive image"> 
...
<img src="/img/screenShot1.png" class="img-responsive" alt="Responsive image">
...
<img src="/img/daredevil3.png" class="img-responsive" align="right"> 
...
<img src="/img/daredevil2.png" class="img-responsive" alt="Responsive image">
